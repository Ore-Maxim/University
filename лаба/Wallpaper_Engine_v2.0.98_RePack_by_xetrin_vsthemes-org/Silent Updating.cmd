...
title ’Ёе®Ґ ®Ў­®ў«Ґ­ЁҐ "Wallpaper Engine %Version%" / Silent update "Wallpaper Engine %Version%"
@cls
echo.
echo.
echo.
...
@echo.  
@echo                                          ЋЃЌЋ‚‹…Ќ€… ‚ ’€•ЋЊ ђ…†€Њ…... / UPDATING IN SILENT MODE...
@echo off
start "" /wait "Wallpaper_Engine_v%Version%_RePack_by_xetrin.exe" /VERYSILENT /UPDATE